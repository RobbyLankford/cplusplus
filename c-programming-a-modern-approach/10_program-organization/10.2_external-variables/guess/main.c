...
/* repeatedly reads user guesses and tells the user whether it is too high, low, or correct */
/* when the guess is corrrect, prints the total number of guesses and returns */
void read_guesses(void)
{
