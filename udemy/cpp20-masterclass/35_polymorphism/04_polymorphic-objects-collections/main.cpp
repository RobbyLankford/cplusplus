...
int main()
{
    ...
    // ... The data is going to be sliced down to the base class!
    ...
    // Cannot store references in a collection: compiler error
    //const Shape &shapes2[] {circle1, oval1, circle2, oval2, circle3, oval3};

    // CAN store raw pointers, which calls the correct draw() methods
