...
// Can use other constructors in a constructor

// One parameter constructor uses the three parameter constructor
...
{
    std::cout << "There param constructor called." << std::endl;
}
