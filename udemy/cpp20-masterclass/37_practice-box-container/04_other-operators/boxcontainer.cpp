...
{
    // Make sure the current box can accomodate the newly added elements
...
void BoxContainer::operator=(const BoxContainer &source)
{
    ...
    /*
        If the capacities are different, set up a new iternal array that matches source,
        because we wnat the object we are assigning to match source as much as possible.
    */
