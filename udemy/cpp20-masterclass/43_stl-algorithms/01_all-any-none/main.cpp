...
int main()
{
    std::vector<int> collection {2, 6, 8, 49, 64, 70};
    ...
    {
        std::cout << "(std::any_of): None of the numbers are divisible by 7." << std::endl;
    }
    ...
    {
        std::cout << "(std::none_of): None of the numbers are odd." << std::endl;
    }
    else
    {
